...
#' module_energy_X244.building_Subregions_Malaysia
#'
...
module_energy_X244.building_Subregions_Malaysia <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    X244.DeleteConsumer_bld_Subregions_Malaysia <- tibble(region = "Malaysia", gcam.consumer = unique(L244.SubregionalShares$gcam.consumer))
    X244.DeleteSupplysector_bld_Subregions_Malaysia <- tibble(region = "Malaysia", supplysector = unique(L244.Supplysector_bld$supplysector))
    ...
    X244.list_nochange_data_Subregions_Malaysia <- list(
    ...
    X244.list_nochange_data_Subregions_Malaysia <- lapply(X244.list_nochange_data_Subregions_Malaysia,
                                      FUN = write_to_breakout_regions,
                                      composite_region = "Malaysia",
                                      disag_regions = c(subregions))

    X244.pop_gdp_share_Subregions_Malaysia <- X201.Pop_Subregions_Malaysia %>%
    ...
    X244.Floorspace_Subregions_Malaysia <- L244.Floorspace %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c(subregions),
                                    share_data = X244.pop_gdp_share_Subregions_Malaysia, value.column = "base.building.size", share.column = "popshare")

    X244.ThermalBaseService_Subregions_Malaysia <- L244.ThermalBaseService %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c(subregions),
                                     share_data = X244.pop_gdp_share_Subregions_Malaysia, value.column = "base.service", share.column = "gdpshare")

    X244.GenericBaseService_Subregions_Malaysia<- L244.GenericBaseService %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c(subregions),
                                     share_data = X244.pop_gdp_share_Subregions_Malaysia, value.column = "base.service", share.column = "gdpshare")

    X244.StubTechCalInput_bld_Subregions_Malaysia<- L244.StubTechCalInput_bld %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c(subregions),
                                     share_data = X244.pop_gdp_share_Subregions_Malaysia, value.column = "calibrated.value", share.column = "gdpshare")

    X244.pol_emissions_bld_Subregions_Malaysia <- L201.en_pol_emissions %>%
      filter(supplysector %in% L244.Supplysector_bld$supplysector) %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c(subregions),
                                     share_data = X244.pop_gdp_share_Subregions_Malaysia, value.column = "input.emissions", share.column = "gdpshare")

    X244.ghg_emissions_bld_Subregions_Malaysia <- L201.en_ghg_emissions %>%
      filter(supplysector %in% L244.Supplysector_bld$supplysector) %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c(subregions),
    ...
    X244.ThermalBaseService_Subregions_Malaysia%>%
      left_join(X244.Floorspace_Subregions_Malaysia, by = c("region", "year", "gcam.consumer", "nodeInput", "building.node.input")) %>%
      ...
      X244.ThermalBaseServicePerFloorspace_Subregions_Malaysia
    ...
    X244.GenericBaseService_Subregions_Malaysia%>%
      ...
      X244.GenericBaseServicePerFloorspace_Subregions_Malaysia

    X244.list_nochange_data_Subregions_Malaysia[["L244.ThermalServiceSatiation"]] %>%
      left_join_error_no_match(X244.ThermalBaseServicePerFloorspace_Subregions_Malaysia,
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.GenericServiceSatiation"]] %>%
      left_join_error_no_match(X244.GenericBaseServicePerFloorspace_Subregions_Malaysia,
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.DeleteThermalService"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.SubregionalShares"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.PriceExp_IntGains"]] %>%
    ...
    X244.Floorspace_Subregions_Malaysia %>%
      ...
      add_precursors("L244.Floorspace", "X201.Pop_Subregions_Malaysia", "X201.GDP_Subregions_Malaysia") ->
      X244.Floorspace_Subregions_Malaysia

      X244.list_nochange_data_Subregions_Malaysia[["L244.DemandFunction_serv"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.DemandFunction_flsp"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.Satiation_flsp"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.SatiationAdder"]] %>%
    ...
    X244.ThermalBaseService_Subregions_Malaysia %>%
      ...
      add_precursors("L244.ThermalBaseService", "X201.Pop_Subregions_Malaysia", "X201.GDP_Subregions_Malaysia") ->
      X244.ThermalBaseService_Subregions_Malaysia
    ...
    X244.GenericBaseService_Subregions_Malaysia %>%
      ...
      add_units("EJ/yr") %>%
      add_comments("L144.base_service_EJ_serv rounded and renamed") %>%
      add_precursors("L244.GenericBaseService", "X201.Pop_Subregions_Malaysia", "X201.GDP_Subregions_Malaysia") ->
      X244.GenericBaseService_Subregions_Malaysia
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.Intgains_scalar"]] %>%
      ...
      X244.list_nochange_data_Subregions_Malaysia[["L244.ShellConductance_bld"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.Supplysector_bld"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.FinalEnergyKeyword_bld"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.SubsectorShrwtFllt_bld"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.SubsectorInterp_bld"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.SubsectorLogit_bld"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.FuelPrefElast_bld"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.StubTech_bld"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.StubTechEff_bld"]] %>%
    ...
    X244.StubTechCalInput_bld_Subregions_Malaysia %>%
      ...
      add_precursors("L244.StubTechCalInput_bld", "X201.Pop_Subregions_Malaysia", "X201.GDP_Subregions_Malaysia") ->
      X244.StubTechCalInput_bld_Subregions_Malaysia

    X244.list_nochange_data_Subregions_Malaysia[["L244.StubTechIntGainOutputRatio"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L244.HDDCDD_constdd_no_GCM"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L241.fgas_all_units"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L201.nonghg_max_reduction"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L201.nonghg_steepness"]] %>%
    ...
    X244.list_nochange_data_Subregions_Malaysia[["L241.hfc_future"]] %>%
    ...
    return_data(X244.DeleteThermalService_bld_Subregions_Malaysia,
                X244.DeleteConsumer_bld_Subregions_Malaysia,
                X244.DeleteSupplysector_bld_Subregions_Malaysia,
                X244.SubregionalShares_Subregions_Malaysia,
                X244.PriceExp_IntGains_Subregions_Malaysia,
