...
module_energy_Xbatch_industry_xml_Bangkok_Thailand<- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    X232.MAC_higwp_ind_Bangkok_Thailand <- get_data(all_data, "X232.MAC_higwp_ind_Bangkok_Thailand")
    ...
    X232.hfc_all_indproc_Bangkok_Thailand <- get_data(all_data, "X232.hfc_all_indproc_Bangkok_Thailand")
    X232.pfc_all_indproc_Bangkok_Thailand <- get_data(all_data, "X232.pfc_all_indproc_Bangkok_Thailand")
    ...
    create_xml("industry_Bangkok_Thailand.xml") %>%
      ...
      add_xml_data(X232.MAC_higwp_ind_Bangkok_Thailand, "MAC") %>%
      ...
      add_xml_data(X232.hfc_all_indproc_Bangkok_Thailand, "StbTechOutputEmissions") %>%
      add_xml_data(X232.pfc_all_indproc_Bangkok_Thailand, "StbTechOutputEmissions") %>%
