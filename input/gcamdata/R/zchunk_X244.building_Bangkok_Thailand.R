...
#' module_energy_X244.building_Bangkok_Thailand
#'
...
module_energy_X244.building_Bangkok_Thailand <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    X244.DeleteConsumer_bld_Bangkok_Thailand <- tibble(region = "Thailand", gcam.consumer = unique(L244.SubregionalShares$gcam.consumer))
    X244.DeleteSupplysector_bld_Bangkok_Thailand <- tibble(region = "Thailand", supplysector = unique(L244.Supplysector_bld$supplysector))
    ...
    X244.list_nochange_data_Bangkok_Thailand <- list(
    ...
    X244.list_nochange_data_Bangkok_Thailand <- lapply(X244.list_nochange_data_Bangkok_Thailand,
                                      FUN = write_to_breakout_regions,
                                      composite_region = "Thailand",
                                      disag_regions = c("Bangkok","Rest of Thailand"))

    X244.pop_gdp_share_Bangkok_Thailand <- X201.Pop_Bangkok_Thailand %>%
    ...
    X244.Floorspace_Bangkok_Thailand <- L244.Floorspace %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Thailand",
                                    disag_regions = c("Bangkok","Rest of Thailand"),
                                    share_data = X244.pop_gdp_share_Bangkok_Thailand, value.column = "base.building.size", share.column = "popshare")

    X244.ThermalBaseService_Bangkok_Thailand <- L244.ThermalBaseService %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Thailand",
                                     disag_regions = c("Bangkok","Rest of Thailand"),
                                     share_data = X244.pop_gdp_share_Bangkok_Thailand, value.column = "base.service", share.column = "gdpshare")

    X244.GenericBaseService_Bangkok_Thailand<- L244.GenericBaseService %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Thailand",
                                     disag_regions = c("Bangkok","Rest of Thailand"),
                                     share_data = X244.pop_gdp_share_Bangkok_Thailand, value.column = "base.service", share.column = "gdpshare")

    X244.StubTechCalInput_bld_Bangkok_Thailand<- L244.StubTechCalInput_bld %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Thailand",
                                     disag_regions = c("Bangkok","Rest of Thailand"),
                                     share_data = X244.pop_gdp_share_Bangkok_Thailand, value.column = "calibrated.value", share.column = "gdpshare")

    X244.pol_emissions_bld_Bangkok_Thailand <- L201.en_pol_emissions %>%
      filter(supplysector %in% L244.Supplysector_bld$supplysector) %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Thailand",
                                     disag_regions = c("Bangkok","Rest of Thailand"),
                                     share_data = X244.pop_gdp_share_Bangkok_Thailand, value.column = "input.emissions", share.column = "gdpshare")

    X244.ghg_emissions_bld_Bangkok_Thailand <- L201.en_ghg_emissions %>%
      filter(supplysector %in% L244.Supplysector_bld$supplysector) %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Thailand",
                                     disag_regions = c("Bangkok","Rest of Thailand"),
    ...
    X244.ThermalBaseService_Bangkok_Thailand%>%
      left_join(X244.Floorspace_Bangkok_Thailand, by = c("region", "year", "gcam.consumer", "nodeInput", "building.node.input")) %>%
      ...
      X244.ThermalBaseServicePerFloorspace_Bangkok_Thailand
    ...
    X244.GenericBaseService_Bangkok_Thailand%>%
      ...
      X244.GenericBaseServicePerFloorspace_Bangkok_Thailand

    X244.list_nochange_data_Bangkok_Thailand[["L244.ThermalServiceSatiation"]] %>%
      left_join_error_no_match(X244.ThermalBaseServicePerFloorspace_Bangkok_Thailand,
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.GenericServiceSatiation"]] %>%
      left_join_error_no_match(X244.GenericBaseServicePerFloorspace_Bangkok_Thailand,
    ...
    X244.DeleteConsumer_bld_Bangkok_Thailand %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.SubregionalShares"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.PriceExp_IntGains"]] %>%
    ...
    X244.Floorspace_Bangkok_Thailand %>%
      ...
      add_precursors("L244.Floorspace", "X201.Pop_Bangkok_Thailand", "X201.GDP_Bangkok_Thailand") ->
      X244.Floorspace_Bangkok_Thailand

      X244.list_nochange_data_Bangkok_Thailand[["L244.DemandFunction_serv"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.DemandFunction_flsp"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.Satiation_flsp"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.SatiationAdder"]] %>%
    ...
    X244.ThermalBaseService_Bangkok_Thailand %>%
      ...
      add_precursors("L244.ThermalBaseService", "X201.Pop_Bangkok_Thailand", "X201.GDP_Bangkok_Thailand") ->
      X244.ThermalBaseService_Bangkok_Thailand
    ...
    X244.GenericBaseService_Bangkok_Thailand %>%
      ...
      add_units("EJ/yr") %>%
      add_comments("L144.base_service_EJ_serv rounded and renamed") %>%
      add_precursors("L244.GenericBaseService", "X201.Pop_Bangkok_Thailand", "X201.GDP_Bangkok_Thailand") ->
      X244.GenericBaseService_Bangkok_Thailand
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.Intgains_scalar"]] %>%
      ...
      X244.list_nochange_data_Bangkok_Thailand[["L244.ShellConductance_bld"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.Supplysector_bld"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.FinalEnergyKeyword_bld"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.SubsectorShrwtFllt_bld"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.SubsectorInterp_bld"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.SubsectorLogit_bld"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.FuelPrefElast_bld"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.StubTech_bld"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.StubTechEff_bld"]] %>%
    ...
    X244.StubTechCalInput_bld_Bangkok_Thailand %>%
      ...
      add_precursors("L244.StubTechCalInput_bld", "X201.Pop_Bangkok_Thailand", "X201.GDP_Bangkok_Thailand") ->
      X244.StubTechCalInput_bld_Bangkok_Thailand

    X244.list_nochange_data_Bangkok_Thailand[["L244.StubTechIntGainOutputRatio"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L244.HDDCDD_constdd_no_GCM"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L241.fgas_all_units"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L201.nonghg_max_reduction"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L201.nonghg_steepness"]] %>%
    ...
    X244.list_nochange_data_Bangkok_Thailand[["L241.hfc_future"]] %>%
    ...
    return_data(X244.DeleteConsumer_bld_Bangkok_Thailand,
                X244.DeleteSupplysector_bld_Bangkok_Thailand,
                X244.SubregionalShares_Bangkok_Thailand,
                X244.PriceExp_IntGains_Bangkok_Thailand,
                X244.Floorspace_Bangkok_Thailand,
