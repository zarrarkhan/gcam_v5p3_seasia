...
#' module_energy_X244.building_KualaLumpur_Malaysia
#'
...
module_energy_X244.building_KualaLumpur_Malaysia <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    X201.Pop_KualaLumpur_Malaysia <- get_data(all_data, "X201.Pop_KualaLumpur_Malaysia", strip_attributes = TRUE)
    X201.GDP_KualaLumpur_Malaysia <- get_data(all_data, "X201.GDP_KualaLumpur_Malaysia", strip_attributes = TRUE)
    ...
    X244.DeleteConsumer_bld_KualaLumpur_Malaysia <- tibble(region = "Malaysia", gcam.consumer = unique(L244.SubregionalShares$gcam.consumer))
    X244.DeleteSupplysector_bld_KualaLumpur_Malaysia <- tibble(region = "Malaysia", supplysector = unique(L244.Supplysector_bld$supplysector))
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia <- lapply(X244.list_nochange_data_KualaLumpur_Malaysia,
                                      FUN = write_to_breakout_regions,
                                      composite_region = "Malaysia",
                                      disag_regions = c("KualaLumpur","Rest of Malaysia"))

    X244.pop_gdp_share_KualaLumpur_Malaysia <- X201.Pop_KualaLumpur_Malaysia %>%
    ...
    X244.Floorspace_KualaLumpur_Malaysia <- L244.Floorspace %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                    share_data = X244.pop_gdp_share_KualaLumpur_Malaysia, value.column = "base.building.size", share.column = "popshare")

    X244.ThermalBaseService_KualaLumpur_Malaysia <- L244.ThermalBaseService %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                     share_data = X244.pop_gdp_share_KualaLumpur_Malaysia, value.column = "base.service", share.column = "gdpshare")

    X244.GenericBaseService_KualaLumpur_Malaysia<- L244.GenericBaseService %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                     share_data = X244.pop_gdp_share_KualaLumpur_Malaysia, value.column = "base.service", share.column = "gdpshare")

    X244.StubTechCalInput_bld_KualaLumpur_Malaysia<- L244.StubTechCalInput_bld %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                     share_data = X244.pop_gdp_share_KualaLumpur_Malaysia, value.column = "calibrated.value", share.column = "gdpshare")

    X244.pol_emissions_bld_KualaLumpur_Malaysia <- L201.en_pol_emissions %>%
      filter(supplysector %in% L244.Supplysector_bld$supplysector) %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                     share_data = X244.pop_gdp_share_KualaLumpur_Malaysia, value.column = "input.emissions", share.column = "gdpshare")

    X244.ghg_emissions_bld_KualaLumpur_Malaysia <- L201.en_ghg_emissions %>%
      filter(supplysector %in% L244.Supplysector_bld$supplysector) %>%
      downscale_to_breakout_regions(data = .,
                                     composite_region = "Malaysia",
                                     disag_regions = c("KualaLumpur","Rest of Malaysia"),
    ...
    X244.ThermalBaseService_KualaLumpur_Malaysia%>%
      left_join(X244.Floorspace_KualaLumpur_Malaysia, by = c("region", "year", "gcam.consumer", "nodeInput", "building.node.input")) %>%
      ...
      X244.ThermalBaseServicePerFloorspace_KualaLumpur_Malaysia
    ...
    X244.GenericBaseService_KualaLumpur_Malaysia%>%
      ...
      X244.GenericBaseServicePerFloorspace_KualaLumpur_Malaysia

    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.ThermalServiceSatiation"]] %>%
      left_join_error_no_match(X244.ThermalBaseServicePerFloorspace_KualaLumpur_Malaysia,
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.GenericServiceSatiation"]] %>%
      left_join_error_no_match(X244.GenericBaseServicePerFloorspace_KualaLumpur_Malaysia,
    ...
    X244.DeleteSupplysector_bld_KualaLumpur_Malaysia %>%
      add_title("Delete supplysector objects for buildings sector in Malaysia", overwrite=TRUE) %>%
      add_units("Unitless") %>%
      add_comments("Malaysia region name hard-wired") %>%
      add_precursors("L244.Supplysector_bld") ->
      X244.DeleteSupplysector_bld_KualaLumpur_Malaysia

    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.SubregionalShares"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.PriceExp_IntGains"]] %>%
    ...
    X244.Floorspace_KualaLumpur_Malaysia %>%
      ...
      add_precursors("L244.Floorspace", "X201.Pop_KualaLumpur_Malaysia", "X201.GDP_KualaLumpur_Malaysia") ->
      X244.Floorspace_KualaLumpur_Malaysia

      X244.list_nochange_data_KualaLumpur_Malaysia[["L244.DemandFunction_serv"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.DemandFunction_flsp"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.Satiation_flsp"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.SatiationAdder"]] %>%
    ...
    X244.ThermalBaseService_KualaLumpur_Malaysia %>%
      ...
      add_precursors("L244.ThermalBaseService", "X201.Pop_KualaLumpur_Malaysia", "X201.GDP_KualaLumpur_Malaysia") ->
      X244.ThermalBaseService_KualaLumpur_Malaysia
    ...
    X244.GenericBaseService_KualaLumpur_Malaysia %>%
      ...
      add_units("EJ/yr") %>%
      add_comments("L144.base_service_EJ_serv rounded and renamed") %>%
      add_precursors("L244.GenericBaseService", "X201.Pop_KualaLumpur_Malaysia", "X201.GDP_KualaLumpur_Malaysia") ->
      X244.GenericBaseService_KualaLumpur_Malaysia
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.Intgains_scalar"]] %>%
      ...
      X244.list_nochange_data_KualaLumpur_Malaysia[["L244.ShellConductance_bld"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.Supplysector_bld"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.FinalEnergyKeyword_bld"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.SubsectorShrwtFllt_bld"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.SubsectorInterp_bld"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.SubsectorLogit_bld"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.FuelPrefElast_bld"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.StubTech_bld"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.StubTechEff_bld"]] %>%
    ...
    X244.StubTechCalInput_bld_KualaLumpur_Malaysia %>%
      ...
      add_precursors("L244.StubTechCalInput_bld", "X201.Pop_KualaLumpur_Malaysia", "X201.GDP_KualaLumpur_Malaysia") ->
      X244.StubTechCalInput_bld_KualaLumpur_Malaysia

    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.StubTechIntGainOutputRatio"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L244.HDDCDD_constdd_no_GCM"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L241.fgas_all_units"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L201.nonghg_max_reduction"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L201.nonghg_steepness"]] %>%
    ...
    X244.list_nochange_data_KualaLumpur_Malaysia[["L241.hfc_future"]] %>%
