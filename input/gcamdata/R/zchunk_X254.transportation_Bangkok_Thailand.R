...
module_energy_X254.transportation_Bangkok_Thailand <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    X254.DeleteFinalDemand_trn_Bangkok_Thailand <- tibble(region = "Thailand",
                                                  energy.final.demand = unique(L254.PerCapitaBased_trn$energy.final.demand))
    X254.DeleteSupplysector_trn_Bangkok_Thailand <- tibble(region = "Thailand",
    ...
    X254.list_nochange_data_Bangkok_Thailand <- list(
    ...
    X254.list_nochange_data_Bangkok_Thailand <- lapply(X254.list_nochange_data_Bangkok_Thailand, FUN = filter_to_core_scenario)
    X254.list_nochange_data_Bangkok_Thailand <- lapply(X254.list_nochange_data_Bangkok_Thailand,
                                      FUN = write_to_breakout_regions,
                                      composite_region = "Thailand",
                                      disag_regions = c("Bangkok","Rest of Thailand"))

    X254.pop_gdp_share_Bangkok_Thailand <- X201.Pop_Bangkok_Thailand %>%
    ...
    X254.StubTranTechCalInput_trn_Bangkok_Thailand <- L254.StubTranTechCalInput %>%
      filter(sce == "CORE") %>%
      downscale_to_breakout_regions(data = .,
                                  composite_region = "Thailand",
                                  disag_regions = c("Bangkok","Rest of Thailand"),
                                  share_data = X254.pop_gdp_share_Bangkok_Thailand, value.column = "calibrated.value", share.column = "popshare")

    X254.StubTechCalInput_passthru_trn_Bangkok_Thailand <- L254.StubTechCalInput_passthru %>%
      filter(sce == "CORE") %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Thailand",
                                    disag_regions = c("Bangkok","Rest of Thailand"),
    ...
    X254.StubTechProd_nonmotor <- L254.StubTechProd_nonmotor %>%
      ...
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Thailand",
                                    disag_regions = c("Bangkok","Rest of Thailand"),
                                    share_data = X254.pop_gdp_share_Bangkok_Thailand, value.column = "calOutputValue", share.column = "popshare",
                                    ndigits = energy.DIGITS_MPKM)

    X254.BaseService_trn_Bangkok_Thailand <- L254.BaseService_trn %>%
      filter(sce == "CORE") %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Thailand",
                                    disag_regions = c("Bangkok","Rest of Thailand"),
                                    share_data = X254.pop_gdp_share_Bangkok_Thailand, value.column = "base.service", share.column = "popshare",
                                    ndigits = energy.DIGITS_MPKM)

    X254.pol_emissions_trn_Bangkok_Thailand <- L201.en_pol_emissions %>%
      filter(supplysector %in% Transport_sectors) %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Thailand",
                                    disag_regions = c("Bangkok","Rest of Thailand"),
                                    share_data = X254.pop_gdp_share_Bangkok_Thailand, value.column = "input.emissions", share.column = "gdpshare")

    X254.ghg_emissions_trn_Bangkok_Thailand <- L201.en_ghg_emissions %>%
      filter(supplysector %in% Transport_sectors) %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Thailand",
                                    disag_regions = c("Bangkok","Rest of Thailand"),
    ...
    X254.DeleteFinalDemand_trn_Bangkok_Thailand %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.Supplysector_trn"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.FinalEnergyKeyword_trn"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorLogit"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorShrwt"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorShrwtFllt"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorInterp"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorSpeed"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorSpeed_passthru"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorSpeed_noVOTT"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorSpeed_nonmotor"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorVOTT"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.tranSubsectorFuelPref"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.StubTranTech"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.StubTech_passthru"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.StubTech_nonmotor"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.StubTranTechLoadFactor"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.StubTranTechCost"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.StubTranTechCoef"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.PerCapitaBased_trn"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.PriceElasticity_trn"]] %>%
    ...
    X254.list_nochange_data_Bangkok_Thailand[["L254.IncomeElasticity_trn"]] %>%
    ...
    X254.StubTranTechCalInput_trn_Bangkok_Thailand %>%
      ...
      add_precursors("L254.StubTranTechCalInput", "X201.Pop_Bangkok_Thailand", "X201.GDP_Bangkok_Thailand") ->
      X254.StubTranTechCalInput_trn_Bangkok_Thailand
    ...
    X254.StubTechCalInput_passthru_trn_Bangkok_Thailand %>%
      ...
      add_precursors("L254.StubTechCalInput_passthru", "X201.Pop_Bangkok_Thailand", "X201.GDP_Bangkok_Thailand") ->
      X254.StubTechCalInput_passthru_trn_Bangkok_Thailand
    ...
    X254.BaseService_trn_Bangkok_Thailand %>%
      ...
      add_precursors("L254.BaseService_trn", "X201.Pop_Bangkok_Thailand", "X201.GDP_Bangkok_Thailand") ->
      X254.BaseService_trn_Bangkok_Thailand

    X254.list_nochange_data_Bangkok_Thailand[["L241.fgas_all_units"]] %>%
      add_title("Units of f-gas emissions from transportation in Bangkok_Thailand") %>%
      add_units("Specified in table") %>%
      add_comments("Copied") %>%
      add_precursors("L241.fgas_all_units") ->
      X254.fgas_all_units_trn_Bangkok_Thailand

    X254.list_nochange_data_Bangkok_Thailand[["L201.nonghg_max_reduction"]] %>%
      add_title("max-reduction of pollutant emissions from transportation in Bangkok_Thailand") %>%
      add_units("Percent") %>%
      add_comments("Copied") %>%
      add_precursors("L201.nonghg_max_reduction") ->
      X254.nonghg_max_reduction_trn_Bangkok_Thailand

    X254.list_nochange_data_Bangkok_Thailand[["L201.nonghg_steepness"]] %>%
      add_title("steepness of pollutant emissions from transportation in Bangkok_Thailand") %>%
      add_units("Unitless") %>%
      add_comments("Copied") %>%
      add_precursors("L201.nonghg_steepness") ->
      X254.nonghg_steepness_trn_Bangkok_Thailand

    X254.list_nochange_data_Bangkok_Thailand[["L241.hfc_future"]] %>%
      add_title("emissions coefficients of f-gases from transportation in Bangkok_Thailand") %>%
    ...
    X254.pol_emissions_trn_Bangkok_Thailand %>%
      add_title("pollutant emissions from Bangkok_Thailand buildings") %>%
      add_units("Tg/yr") %>%
    ...
    X254.ghg_emissions_trn_Bangkok_Thailand %>%
      add_title("greenhouse gas emissions from Bangkok_Thailand buildings") %>%
      add_units("Tg/yr") %>%
      add_comments("downscaled from Thailand using GDP shares") %>%
      add_precursors("L201.en_ghg_emissions") ->
      X254.ghg_emissions_trn_Bangkok_Thailand

    return_data(X254.DeleteFinalDemand_trn_Bangkok_Thailand,
                X254.DeleteSupplysector_trn_Bangkok_Thailand,
                X254.Supplysector_trn_Bangkok_Thailand,
                X254.FinalEnergyKeyword_trn_Bangkok_Thailand,
                X254.tranSubsectorLogit_trn_Bangkok_Thailand,
