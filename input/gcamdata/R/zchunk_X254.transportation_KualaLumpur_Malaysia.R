...
module_energy_X254.transportation_KualaLumpur_Malaysia <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    X254.DeleteFinalDemand_trn_KualaLumpur_Malaysia <- tibble(region = "Malaysia",
                                                  energy.final.demand = unique(L254.PerCapitaBased_trn$energy.final.demand))
    X254.DeleteSupplysector_trn_KualaLumpur_Malaysia <- tibble(region = "Malaysia",
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia <- list(
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia <- lapply(X254.list_nochange_data_KualaLumpur_Malaysia, FUN = filter_to_core_scenario)
    X254.list_nochange_data_KualaLumpur_Malaysia <- lapply(X254.list_nochange_data_KualaLumpur_Malaysia,
                                      FUN = write_to_breakout_regions,
                                      composite_region = "Malaysia",
                                      disag_regions = c("KualaLumpur","Rest of Malaysia"))

    X254.pop_gdp_share_KualaLumpur_Malaysia <- X201.Pop_KualaLumpur_Malaysia %>%
    ...
    X254.StubTranTechCalInput_trn_KualaLumpur_Malaysia <- L254.StubTranTechCalInput %>%
      filter(sce == "CORE") %>%
      downscale_to_breakout_regions(data = .,
                                  composite_region = "Malaysia",
                                  disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                  share_data = X254.pop_gdp_share_KualaLumpur_Malaysia, value.column = "calibrated.value", share.column = "popshare")

    X254.StubTechCalInput_passthru_trn_KualaLumpur_Malaysia <- L254.StubTechCalInput_passthru %>%
      filter(sce == "CORE") %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c("KualaLumpur","Rest of Malaysia"),
    ...
    X254.StubTechProd_nonmotor <- L254.StubTechProd_nonmotor %>%
      ...
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                    share_data = X254.pop_gdp_share_KualaLumpur_Malaysia, value.column = "calOutputValue", share.column = "popshare",
                                    ndigits = energy.DIGITS_MPKM)

    X254.BaseService_trn_KualaLumpur_Malaysia <- L254.BaseService_trn %>%
      filter(sce == "CORE") %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                    share_data = X254.pop_gdp_share_KualaLumpur_Malaysia, value.column = "base.service", share.column = "popshare",
                                    ndigits = energy.DIGITS_MPKM)

    X254.pol_emissions_trn_KualaLumpur_Malaysia <- L201.en_pol_emissions %>%
      filter(supplysector %in% Transport_sectors) %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c("KualaLumpur","Rest of Malaysia"),
                                    share_data = X254.pop_gdp_share_KualaLumpur_Malaysia, value.column = "input.emissions", share.column = "gdpshare")

    X254.ghg_emissions_trn_KualaLumpur_Malaysia <- L201.en_ghg_emissions %>%
      filter(supplysector %in% Transport_sectors) %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c("KualaLumpur","Rest of Malaysia"),
    ...
    X254.DeleteFinalDemand_trn_KualaLumpur_Malaysia %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.Supplysector_trn"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.FinalEnergyKeyword_trn"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorLogit"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorShrwt"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorShrwtFllt"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorInterp"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorSpeed"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorSpeed_passthru"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorSpeed_noVOTT"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorSpeed_nonmotor"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorVOTT"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.tranSubsectorFuelPref"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.StubTranTech"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.StubTech_passthru"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.StubTech_nonmotor"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.StubTranTechLoadFactor"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.StubTranTechCost"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.StubTranTechCoef"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.PerCapitaBased_trn"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.PriceElasticity_trn"]] %>%
    ...
    X254.list_nochange_data_KualaLumpur_Malaysia[["L254.IncomeElasticity_trn"]] %>%
    ...
    X254.StubTranTechCalInput_trn_KualaLumpur_Malaysia %>%
      ...
      add_precursors("L254.StubTranTechCalInput", "X201.Pop_KualaLumpur_Malaysia", "X201.GDP_KualaLumpur_Malaysia") ->
      X254.StubTranTechCalInput_trn_KualaLumpur_Malaysia
    ...
    X254.StubTechCalInput_passthru_trn_KualaLumpur_Malaysia %>%
      ...
      add_precursors("L254.StubTechCalInput_passthru", "X201.Pop_KualaLumpur_Malaysia", "X201.GDP_KualaLumpur_Malaysia") ->
      X254.StubTechCalInput_passthru_trn_KualaLumpur_Malaysia
    ...
    X254.BaseService_trn_KualaLumpur_Malaysia %>%
      ...
      add_precursors("L254.BaseService_trn", "X201.Pop_KualaLumpur_Malaysia", "X201.GDP_KualaLumpur_Malaysia") ->
      X254.BaseService_trn_KualaLumpur_Malaysia

    X254.list_nochange_data_KualaLumpur_Malaysia[["L241.fgas_all_units"]] %>%
      add_title("Units of f-gas emissions from transportation in KualaLumpur_Malaysia") %>%
      add_units("Specified in table") %>%
      add_comments("Copied") %>%
      add_precursors("L241.fgas_all_units") ->
      X254.fgas_all_units_trn_KualaLumpur_Malaysia

    X254.list_nochange_data_KualaLumpur_Malaysia[["L201.nonghg_max_reduction"]] %>%
      add_title("max-reduction of pollutant emissions from transportation in KualaLumpur_Malaysia") %>%
      add_units("Percent") %>%
      add_comments("Copied") %>%
      add_precursors("L201.nonghg_max_reduction") ->
      X254.nonghg_max_reduction_trn_KualaLumpur_Malaysia

    X254.list_nochange_data_KualaLumpur_Malaysia[["L201.nonghg_steepness"]] %>%
      add_title("steepness of pollutant emissions from transportation in KualaLumpur_Malaysia") %>%
      add_units("Unitless") %>%
      add_comments("Copied") %>%
      add_precursors("L201.nonghg_steepness") ->
      X254.nonghg_steepness_trn_KualaLumpur_Malaysia

    X254.list_nochange_data_KualaLumpur_Malaysia[["L241.hfc_future"]] %>%
      add_title("emissions coefficients of f-gases from transportation in KualaLumpur_Malaysia") %>%
    ...
    X254.pol_emissions_trn_KualaLumpur_Malaysia %>%
      add_title("pollutant emissions from KualaLumpur_Malaysia buildings") %>%
      add_units("Tg/yr") %>%
    ...
    X254.ghg_emissions_trn_KualaLumpur_Malaysia %>%
      add_title("greenhouse gas emissions from KualaLumpur_Malaysia buildings") %>%
      add_units("Tg/yr") %>%
      add_comments("downscaled from Malaysia using GDP shares") %>%
      add_precursors("L201.en_ghg_emissions") ->
      X254.ghg_emissions_trn_KualaLumpur_Malaysia

    return_data(X254.DeleteFinalDemand_trn_KualaLumpur_Malaysia,
                X254.DeleteSupplysector_trn_KualaLumpur_Malaysia,
                X254.Supplysector_trn_KualaLumpur_Malaysia,
                X254.FinalEnergyKeyword_trn_KualaLumpur_Malaysia,
                X254.tranSubsectorLogit_trn_KualaLumpur_Malaysia,
